    ...
    const enviar = async (dados: Produto) => {
        try{
            const corpo = {
                ...
                valor: parseFloat(dados.valor), //converte para Float
                quantidade: parseInt(dados.quantidade), //converte para Int
                data_cadastro: new Date().toISOString().split("T")[0] //DATA
            }
